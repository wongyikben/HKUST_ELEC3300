...
#define SCL_read      GPIO_ReadInputDataBit(GPIOA , GPIO_Pin_0)
//	SDA - PA1
#define SDA_H         GPIO_SetBits(GPIOA , GPIO_Pin_1)
#define SDA_L         GPIO_ResetBits(GPIOA , GPIO_Pin_1)
#define SDA_read      GPIO_ReadInputDataBit(GPIOA , GPIO_Pin_1)


//ov7725 fifo
//	OE - PA15
#define FIFO_OE_H()     GPIOA->BSRR =GPIO_Pin_15
#define FIFO_OE_L()     GPIOA->BRR  =GPIO_Pin_15
//	RRST - PA12
#define FIFO_RRST_H()   GPIOA->BSRR =GPIO_Pin_12
#define FIFO_RRST_L()   GPIOA->BRR  =GPIO_Pin_12
//	RCLK - PB1
#define FIFO_RCLK_H()   GPIOB->BSRR =GPIO_Pin_1
#define FIFO_RCLK_L()   GPIOB->BRR  =GPIO_Pin_1
//	WRST - PC5
#define FIFO_WRST_H()   GPIOC->BSRR =GPIO_Pin_5
#define FIFO_WRST_L()   GPIOC->BRR  =GPIO_Pin_5
//	WEN - PC4
#define FIFO_WEN_H()     GPIOC->BSRR =GPIO_Pin_4
#define FIFO_WEN_L()     GPIOC->BRR  =GPIO_Pin_4
//	Data - PB8 to PB15
//		GPIOB->IDR
//	VSYNC - PB0
//		EXTI&NVIC
//	Data - Capture data
#define FIFO_READY	                do{\
	                                  FIFO_RRST_L();\
	                                  FIFO_RCLK_L();\
	                                  FIFO_RCLK_H();\
	                                  FIFO_RRST_H();\
...
#define READ_FIFO_COLOUR(RGB565)   	do{\
																		RGB565=0;\
																		FIFO_RCLK_L();\
...
#define READ_FIFO_GREYSCALE(GREY)		do{\
																		FIFO_RCLK_L();\
																		GREY = ((GPIOB->IDR >> 8));\
																		FIFO_RCLK_H();\
																		FIFO_RCLK_L();\
